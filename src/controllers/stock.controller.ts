...
function assertOptionalQueryId(
    value: unknown,
    fieldName: string,
) {
    if (
...
export async function getStock(
    ...
    try {
         ...
         * └── MovementStatus
         *
         * Garment ya pertenece directamente
         * al cliente mediante client_id.
         */
        const stock =
            await GarmentStock.findAll({
                where,
