...
export async function getUsers(req: Request, res: Response) {
  try {
    ...
    return res
      .status(500)
      .json({ ok: false, message: "Error obteniendo usuarios" });
  }
}
...
export async function createUser(req: Request, res: Response) {
  try {
    ...
    return res
      .status(500)
      .json({ ok: false, message: "Error creando usuario" });
  }
}
...
export async function deactivateUser(req: Request, res: Response) {
  try {
    ...
    return res
      .status(500)
      .json({ ok: false, message: "Error desactivando usuario" });
  }
}
